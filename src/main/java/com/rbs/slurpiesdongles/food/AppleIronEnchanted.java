...
public class AppleIronEnchanted extends ItemFood {
    public AppleIronEnchanted(int amount, float saturation, boolean isWolfFood, String name, Item.Properties builder) {
    ...
    public void addInformation(ItemStack stack, @Nullable World worldIn, List<ITextComponent> tooltip, ITooltipFlag flagIn) {
        tooltip.add(new TextComponentString("Grants Absorbtion, & Strength"));
    }
}
