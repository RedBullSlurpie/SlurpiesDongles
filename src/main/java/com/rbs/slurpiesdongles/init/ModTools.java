...
public class ModTools {
    ...
    public static Item TOPAZ_BATTLEAXE = new CustomSword("topaz_battleaxe", ToolMaterials.TOPAZ_BATTLEAXE, 7, -3.0F, new Item.Properties().group(Reference.tabSlurpiesDongles).rarity(Rarity.RARE));
