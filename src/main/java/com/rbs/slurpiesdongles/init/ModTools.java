...
public class ModTools {
    ...
    public static void registerItems(RegistryEvent.Register<Item> event) {
        ...
        if (ConfigGeneral.disableAmazoniteTools.get()) {
            event.getRegistry().register(amazonite_axe = new CustomAxe(ToolMaterials.AMAZONITE, 4, -3.1F, new Item.Properties().group(Reference.tabSlurpiesDongles), HarvestLevelHelper.AMAZONITE, "amazonite_axe"));
            ...
            event.getRegistry().register(amazonite_paxel = new Paxel(ToolMaterials.AMAZONITE_PAXEL, 4, -3.0F,  new Item.Properties().group(Reference.tabSlurpiesDongles), HarvestLevelHelper.AMAZONITE, "amazonite_paxel"));
            event.getRegistry().register(amazonite_pickaxe = new CustomPickaxe(ToolMaterials.AMAZONITE, 1, -2.8F, new Item.Properties().group(Reference.tabSlurpiesDongles), HarvestLevelHelper.AMAZONITE, "amazonite_pickaxe"));
            event.getRegistry().register(amazonite_shovel = new CustomShovel(ToolMaterials.AMAZONITE, 1, -2.6F, new Item.Properties().group(Reference.tabSlurpiesDongles), HarvestLevelHelper.AMAZONITE, "amazonite_shovel"));
        ...
        if (ConfigGeneral.disableAmethystTools.get()) {
            event.getRegistry().register(amethyst_axe = new CustomAxe(ToolMaterials.AMETHYST, 4, -3.1F, new Item.Properties().group(Reference.tabSlurpiesDongles), HarvestLevelHelper.AMETHYST, "amethyst_axe"));
            ...
            event.getRegistry().register(amethyst_paxel = new Paxel(ToolMaterials.AMETHYST_PAXEL, 4, -3.0F,  new Item.Properties().group(Reference.tabSlurpiesDongles), HarvestLevelHelper.AMETHYST, "amethyst_paxel"));
            event.getRegistry().register(amethyst_pickaxe = new CustomPickaxe(ToolMaterials.AMETHYST, 1, -2.8F, new Item.Properties().group(Reference.tabSlurpiesDongles), HarvestLevelHelper.AMETHYST, "amethyst_pickaxe"));
            event.getRegistry().register(amethyst_shovel = new CustomShovel(ToolMaterials.AMETHYST, 1, -2.6F, new Item.Properties().group(Reference.tabSlurpiesDongles), HarvestLevelHelper.AMETHYST, "amethyst_shovel"));
        ...
        if (ConfigGeneral.disablePeridotTools.get()) {
            event.getRegistry().register(peridot_axe = new CustomAxe(ToolMaterials.PERIDOT, 3, -3.1F, new Item.Properties().group(Reference.tabSlurpiesDongles), HarvestLevelHelper.PERIDOT, "peridot_axe"));
            ...
            event.getRegistry().register(peridot_paxel = new Paxel(ToolMaterials.PERIDOT_PAXEL, 3, -3.0F,  new Item.Properties().group(Reference.tabSlurpiesDongles), HarvestLevelHelper.PERIDOT, "peridot_paxel"));
            event.getRegistry().register(peridot_pickaxe = new CustomPickaxe(ToolMaterials.PERIDOT, 1, -2.8F, new Item.Properties().group(Reference.tabSlurpiesDongles), HarvestLevelHelper.PERIDOT, "peridot_pickaxe"));
            event.getRegistry().register(peridot_shovel = new CustomShovel(ToolMaterials.PERIDOT, 1, -2.6F, new Item.Properties().group(Reference.tabSlurpiesDongles), HarvestLevelHelper.PERIDOT, "peridot_shovel"));
        ...
        if (ConfigGeneral.disableRubyTools.get()) {
            event.getRegistry().register(ruby_axe = new CustomAxe(ToolMaterials.RUBY, 4, -3.1F, new Item.Properties().group(Reference.tabSlurpiesDongles), HarvestLevelHelper.RUBY, "ruby_axe"));
            ...
            event.getRegistry().register(ruby_paxel = new Paxel(ToolMaterials.RUBY_PAXEL, 4, -3.0F,  new Item.Properties().group(Reference.tabSlurpiesDongles), HarvestLevelHelper.RUBY, "ruby_paxel"));
            event.getRegistry().register(ruby_pickaxe = new CustomPickaxe(ToolMaterials.RUBY, 1, -2.8F, new Item.Properties().group(Reference.tabSlurpiesDongles), HarvestLevelHelper.RUBY, "ruby_pickaxe"));
            event.getRegistry().register(ruby_shovel = new CustomShovel(ToolMaterials.RUBY, 1, -2.6F, new Item.Properties().group(Reference.tabSlurpiesDongles), HarvestLevelHelper.RUBY, "ruby_shovel"));
        ...
        if (ConfigGeneral.disableSapphireTools.get()) {
            event.getRegistry().register(sapphire_axe = new CustomAxe(ToolMaterials.SAPPHIRE, 3, -3.1F, new Item.Properties().group(Reference.tabSlurpiesDongles), HarvestLevelHelper.SAPPHIRE, "sapphire_axe"));
            ...
            event.getRegistry().register(sapphire_paxel = new Paxel(ToolMaterials.SAPPHIRE_PAXEL, 3, -3.0F,  new Item.Properties().group(Reference.tabSlurpiesDongles), HarvestLevelHelper.SAPPHIRE, "sapphire_paxel"));
            event.getRegistry().register(sapphire_pickaxe = new CustomPickaxe(ToolMaterials.SAPPHIRE, 1, -2.8F, new Item.Properties().group(Reference.tabSlurpiesDongles), HarvestLevelHelper.SAPPHIRE, "sapphire_pickaxe"));
            event.getRegistry().register(sapphire_shovel = new CustomShovel(ToolMaterials.SAPPHIRE, 1, -2.6F, new Item.Properties().group(Reference.tabSlurpiesDongles), HarvestLevelHelper.SAPPHIRE, "sapphire_shovel"));
        ...
        if (ConfigGeneral.disableTopazTools.get()) {
            event.getRegistry().register(topaz_axe = new CustomAxe(ToolMaterials.TOPAZ, 7, -3.1F, new Item.Properties().group(Reference.tabSlurpiesDongles), HarvestLevelHelper.TOPAZ, "topaz_axe"));
            ...
            event.getRegistry().register(topaz_paxel = new Paxel(ToolMaterials.TOPAZ_PAXEL, 6, -3.0F,  new Item.Properties().group(Reference.tabSlurpiesDongles), HarvestLevelHelper.TOPAZ, "topaz_paxel"));
            event.getRegistry().register(topaz_pickaxe = new CustomPickaxe(ToolMaterials.TOPAZ, 1, -2.8F, new Item.Properties().group(Reference.tabSlurpiesDongles), HarvestLevelHelper.TOPAZ, "topaz_pickaxe"));
            event.getRegistry().register(topaz_shovel = new CustomShovel(ToolMaterials.TOPAZ, 1, -2.6F, new Item.Properties().group(Reference.tabSlurpiesDongles), HarvestLevelHelper.TOPAZ, "topaz_shovel"));
        ...
        if (ConfigGeneral.disableWitheredTools.get()) {
            event.getRegistry().register(withered_axe = new CustomAxe(ToolMaterials.WITHERED, 8, -3.1F, new Item.Properties().group(Reference.tabSlurpiesDongles), HarvestLevelHelper.TOPAZ, "withered_axe"));
            ...
            event.getRegistry().register(withered_paxel = new Paxel(ToolMaterials.WITHERED_PAXEL, 7, -3.0F,  new Item.Properties().group(Reference.tabSlurpiesDongles), HarvestLevelHelper.TOPAZ, "withered_paxel"));
            event.getRegistry().register(withered_pickaxe = new CustomPickaxe(ToolMaterials.WITHERED, 1, -2.8F, new Item.Properties().group(Reference.tabSlurpiesDongles), HarvestLevelHelper.TOPAZ, "withered_pickaxe"));
            event.getRegistry().register(withered_shovel = new CustomShovel(ToolMaterials.WITHERED, 1, -2.6F, new Item.Properties().group(Reference.tabSlurpiesDongles), HarvestLevelHelper.TOPAZ, "withered_shovel"));
        ...
        if (ConfigGeneral.disableDiamondToolsExtras.get()) {
            ...
            event.getRegistry().register(diamond_paxel = new Paxel(ToolMaterials.DIAMOND_PAXEL, 3, -3.0F,  new Item.Properties().group(Reference.tabSlurpiesDongles), HarvestLevelHelper.DIAMOND, "diamond_paxel"));
        }
        if (ConfigGeneral.disableEmeraldToolsExtras.get()) {
            event.getRegistry().register(emerald_axe = new CustomAxe(ToolMaterials.EMERALD, 4, -3.1F, new Item.Properties().group(Reference.tabSlurpiesDongles), HarvestLevelHelper.DIAMOND, "emerald_axe"));
            ...
            event.getRegistry().register(emerald_paxel = new Paxel(ToolMaterials.EMERALD_PAXEL, 4, -3.0F,  new Item.Properties().group(Reference.tabSlurpiesDongles), HarvestLevelHelper.DIAMOND, "emerald_paxel"));
            event.getRegistry().register(emerald_pickaxe = new CustomPickaxe(ToolMaterials.EMERALD, 1, -2.8F, new Item.Properties().group(Reference.tabSlurpiesDongles), HarvestLevelHelper.DIAMOND, "emerald_pickaxe"));
            event.getRegistry().register(emerald_shovel = new CustomShovel(ToolMaterials.EMERALD, 1, -2.6F, new Item.Properties().group(Reference.tabSlurpiesDongles), HarvestLevelHelper.DIAMOND, "emerald_shovel"));
        ...
        if (ConfigGeneral.disableGoldToolsExtras.get()) {
            ...
            event.getRegistry().register(gold_paxel = new Paxel(ToolMaterials.GOLD_PAXEL, 3, -3.0F,  new Item.Properties().group(Reference.tabSlurpiesDongles), HarvestLevelHelper.GOLD, "gold_paxel"));
        }
        if (ConfigGeneral.disableIronToolsExtras.get()) {
            ...
            event.getRegistry().register(iron_paxel = new Paxel(ToolMaterials.IRON_PAXEL, 3, -3.0F,  new Item.Properties().group(Reference.tabSlurpiesDongles), HarvestLevelHelper.IRON, "iron_paxel"));
        }
        if (ConfigGeneral.disableStoneToolsExtras.get()) {
            ...
            event.getRegistry().register(stone_paxel = new Paxel(ToolMaterials.STONE_PAXEL, 2, -3.0F,  new Item.Properties().group(Reference.tabSlurpiesDongles), HarvestLevelHelper.STONE, "stone_paxel"));
        }
        if (ConfigGeneral.disableWoodenToolsExtras.get()) {
            ...
            event.getRegistry().register(wooden_paxel = new Paxel(ToolMaterials.WOODEN_PAXEL, 3, -3.0F,  new Item.Properties().group(Reference.tabSlurpiesDongles), HarvestLevelHelper.WOOD, "wooden_paxel"));
        }
        if (ConfigGeneral.disableVMTools.get()) {
            ...
            event.getRegistry().register(vmpick = new CustomPickaxe(ToolMaterials.VMPICK, 1, -2.8F, new Item.Properties().group(Reference.tabSlurpiesDongles), HarvestLevelHelper.STONE, "vmpick"));
        }
    }
}
