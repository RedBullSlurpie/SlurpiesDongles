...
//Blocks
    ...
    public static void registerBlocks(RegistryEvent.Register<Block> event) {
        event.getRegistry().registerAll(
                //Blocks
                new CustomBricks(Block.Properties.create(Material.ROCK).hardnessAndResistance(2.0F, 10.0F), HarvestLevelHelper.STONE, "blue_bricks"),
                new CustomBricks(Block.Properties.create(Material.ROCK).hardnessAndResistance(2.0F, 10.0F), HarvestLevelHelper.STONE, "cyan_bricks"),
                new CustomBricks(Block.Properties.create(Material.ROCK).hardnessAndResistance(2.0F, 10.0F), HarvestLevelHelper.STONE, "green_bricks"),
                new CustomBricks(Block.Properties.create(Material.ROCK).hardnessAndResistance(2.0F, 10.0F), HarvestLevelHelper.STONE, "orange_bricks"),
                new CustomBricks(Block.Properties.create(Material.ROCK).hardnessAndResistance(2.0F, 10.0F), HarvestLevelHelper.STONE, "purple_bricks"),
                new CustomBricks(Block.Properties.create(Material.ROCK).hardnessAndResistance(2.0F, 10.0F), HarvestLevelHelper.STONE, "rainbow_bricks"),
                new CustomBricks(Block.Properties.create(Material.ROCK).hardnessAndResistance(2.0F, 10.0F), HarvestLevelHelper.STONE, "yellow_bricks"),
                ...
                new BlockBase(Block.Properties.create(Material.ROCK).hardnessAndResistance(3.0F, 5.0F), HarvestLevelHelper.AMAZONITE, "amazonite_block"),
                new BlockBase(Block.Properties.create(Material.ROCK).hardnessAndResistance(3.0F, 5.0F), HarvestLevelHelper.AMETHYST, "amethyst_block"),
                new BlockBase(Block.Properties.create(Material.ROCK).hardnessAndResistance(10.0F, 25.0F), HarvestLevelHelper.TOPAZ, "hardened_topaz_block"),
                new BlockBase(Block.Properties.create(Material.ROCK).hardnessAndResistance(3.0F, 5.0F), HarvestLevelHelper.PERIDOT, "peridot_block"),
                ...
                //Ores
                new AmazoniteOre(Block.Properties.create(Material.ROCK).hardnessAndResistance(3.0F, 3.0F), HarvestLevelHelper.AMAZONITE, "amazonite_ore"),
                new AmethystOre(Block.Properties.create(Material.ROCK).hardnessAndResistance(3.0F, 3.0F), HarvestLevelHelper.AMETHYST, "amethyst_ore"),
                new PeridotOre(Block.Properties.create(Material.ROCK).hardnessAndResistance(3.0F, 3.0F), HarvestLevelHelper.IRON, "peridot_ore"),
