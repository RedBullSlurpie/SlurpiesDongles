    ...
    public static void setupOreGen() {
        ...
        for (Biome biome : ForgeRegistries.BIOMES) {
            ...
            if (WildCropsWorldGen.wild_crops != null) {
                biome.addFeature(GenerationStage.Decoration.VEGETAL_DECORATION, Biome.createDecoratedFeature(WildCropsWorldGen.wild_crops, IFeatureConfig.NO_FEATURE_CONFIG, Placement.DARK_OAK_TREE, IPlacementConfig.NO_PLACEMENT_CONFIG));
            }
